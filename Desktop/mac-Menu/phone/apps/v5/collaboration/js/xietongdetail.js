...
function openfujian(){
    ...
    cmp.href.next(olddaibanBasePath+"/html/fujian.html",extData,{openWebViewCatch: true,nativeBanner: false})
}
//打开意见页面
function openyijian(){
    var extData = cmp.href.getParam()
    cmp.href.next(olddaibanBasePath+"/html/yijian.html",extData,{openWebViewCatch: true,nativeBanner: false})
}
