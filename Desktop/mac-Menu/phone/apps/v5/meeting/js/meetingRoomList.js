...
cmp.ready(function () {
	...
	initPageBack();
	setPageTitle("meeting.meetingRoomList.list");
...
function initEvent(){
    ...
    //视频会议室不支持点击详情
    if (urlParam['action'] != "createVideoMeeting") {
    	cmp("#meetingRoomList").on("tap", ".room_list", function() {
    		...
    		cmp.href.next(_meetingPath + "/html/meetingRoomOccupancyCondition.html"+meetingBuildVersion, paramData);
    	});
    }
