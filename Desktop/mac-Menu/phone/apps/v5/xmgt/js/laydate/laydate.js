...
function() {
    ...
    T.prototype.position = function() {
        ...
        //m3中会遮住header，做此处理
         e.elem.style.top=document.getElementsByClassName("cmp-title")[0].offsetHeight+"px"
    },
    ...
    */
        function(e, t) {
            m(t, l[e], e)
        })) : m(o, l) : ({}, a !=0) : l && l.constructor === Date ? r.dateTime = i.systemDate(l) : (r.dateTime = i.systemDate(), delete i.startState, delete i.endState, delete i.startDate, delete i.endDate, delete i.startTime, delete i.endTime), c(o), a && l && i.setValue(r.range ? i.endDate ? i.parse() : "": i.parse()), e && e(), i)
    ...
    T.prototype.done = function(e, t) {
        //满足项目要求添加如下一行代码，隐藏一月份
        //$($(".laydate-month-list").find("li")[0]).addClass("laydate-disabled");
        var n = this,
        a = n.config,
        i = w.extend({},
    ...
    T.prototype.change = function(e) {
        ...
        return {
            prevYear: function() {
                //为满足项目需求，对以下一行源代码进行修改，去掉切换年时回调change方法
                //s("sub") || (a.year--, t.checkDate("limit").calendar(), n.range || t.done('prevYear', "change"))
                try{
                    (a.year--, t.checkDate("limit").calendar(), n.range || t.done('prevYear', "change"))
                }catch(e){
            ...
            nextYear: function() {
                //为满足项目需求，对以下一行源代码进行修改，去掉切换年时回调change方法
                //s() || (a.year++, t.checkDate("limit").calendar(), n.range || t.done('nextYear', "change"))
                try{
                    (a.year++, t.checkDate("limit").calendar(), n.range || t.done('nextYear', "change"))
                }catch(e){
