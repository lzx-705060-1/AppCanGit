...
s3utils=function(aUtils){
	 ...
	 * 压入待绑定的信息
	 * 
	 * @param aDomBind Dom的绑定信息,使用 document.querySelector进行查找
	 * @param aEventName 事件的名称
	 * @param aEventFunc 事件的处理函数
	 * @param aUseCapture 事件的捕获方式,捕获还是冒泡
	 */
	 ...
	 * 压入待绑定的信息
	 * 
	 * @param aDomBind Dom的绑定信息,使用 document.querySelectorAll进行查找
	 * @param aEventName 事件的名称
	 * @param aEventFunc 事件的处理函数
	 * @param aUseCapture 事件的捕获方式,捕获还是冒泡
	 */
