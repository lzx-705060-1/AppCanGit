        ...
        */
        if (typeof arguments[1] == 'object' && typeof arguments[1][0] == 'object') {
            for (var i=0,len=arguments[1].length; i<len; ++i) {
                ...
                this.min = Math.min(this.min, RGraph.arrayMin(arguments[1][i]));
            ...
            for (var i=1,len=arguments.length; i<len; ++i) {
                ...
                this.min = Math.min(this.min, RGraph.arrayMin(arguments[i]));
            }
        }
...
//            }
        ...
        */
        ...
        this.Draw = function ()
        {
            ...
            */
            ...
            if (!prop['chart.ymax']) {
                ...
                if (prop['chart.accumulative']) {
                    ...
                    for (var i=1; i<this.original_data.length; ++i) {
                        ...
                        for (var j=0; j<this.original_data[i].length; ++j) {
                            ...
                            this.min = Math.min(this.min, this.data[i][j]);
                        }
                    }
                }
                ...
                this.scale2 = RG.getScale2(this, {'max':typeof(prop['chart.ymax']) == 'number' ? prop['chart.ymax'] : this.max,
                                                  'min':this.min < 0?(typeof(prop['chart.ymax']) == 'number' ? -prop['chart.ymax'] : -this.max):0,
            ...
            */
            co.save();
                co.beginPath();
                    co.arc(this.centerx, this.centery/2, this.radius * 2, -RG.HALFPI, (RG.TWOPI * prop['chart.animation.trace.clip']) - RG.HALFPI, false);
                    co.lineTo(this.centerx, this.centery/2);
                co.closePath();
                co.clip();
        ...
        */
        ...
        this.GetCoordinates = function (dataset, index)
        {
            ...
            if(this.min<0){
                var mag = ((this.data[dataset][index] / this.max) + 1) * this.radius/2 ;
            }
...
//                    var newAngle = angle*180/RG.PI;//TODO 可以撤销注释
//                    if(x < this.centerx){
//                        newAngle += 180;
//                    }
//                    if(i == 0 || (i/labels.length) == 0.5){
            ...
            */
            ...
            if (drawzero) {
                RG.Text2(this, {'font':font,
                                ...
                                'x':centerx,
                                'y':centery,
                                'text':RG.number_format(this, this.scale2.min.toFixed(decimals), units_pre, units_post),
                                'valign':'center',
                                'halign':'center',
