/*! appcan v1.1.2 |  from 3g2win.com *//* Zepto v1.1.4 - zepto event ajax form ie - zeptojs.com/license */
                                ...
                                callback:function(err,data,dataType,optId){
                                    if(err == null){
                                        ...
                                        if (typeof(tempSucc) == 'function') {
                                            ...
                                            if(tempComp && typeof(tempComp) == 'function') {
                                                opts.complete("success",null)
                                            }
                                        }
                                    }else{
                                        var tempSucc = opts.success;
