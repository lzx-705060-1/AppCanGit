...
function getUserInfo(){
    ...
    try{
        $.ajax({
            type : 'GET',
            url : url,
			//url : 'https://oamobiletest.agile.com.cn/oa2/psnmessage?code='+username,
            dataType : 'json',
            async : false,
            timeout : 50000,
            success : function(data) {
                ...
                if(data&&data!=""){
                    ...
                    cmp.storage.save('ygzz_org_department_id',data.user.DATA.org_department_id)
                    cmp.storage.save("ygzz_org_account_id",data.user.DATA.org_account_id);
                    cmp.storage.save("ygzz_superior",data.user.DATA.superior);
                }
...
function bindEvent(){
    ...
    document.getElementsByClassName("cmp-header-right")[0].addEventListener("tap",function(){
        ...
        //存储页面数据
        cmp.storage.save("xietongcontent",$("#content").html())
...
function httpsucess(data) {
    if(isFromQYWX){
        if(data.attachments.node_policy=="finish"){
            //影藏右侧按钮
            $(".cmp-header-right").css("display","none");
        }
        else if(data.attachments.state=="4"){
            cmp.notification.alert("该流程已处理！",function(){
                //do something after tap button
                cmp.href.next("/seeyon/m3/apps/v5/portal/todo/html/todo-list.html?from=wxdaiban")
            },"提示","确定","",false,false);
            return;
        }else if(data.attachments.state!="3"){
            cmp.notification.alert("该流程已作废或撤回！",function(){
                //do something after tap button
                cmp.href.next("/seeyon/m3/apps/v5/portal/todo/html/todo-list.html?from=wxdaiban")
            },"提示","确定","",false,false);
            return;
...
function get_new_content(data) {
    ...
    //酒店行政车辆维修申请表
        ...
        html += '<tr class="color3" style="width:100%; "><td style="width:40%;"><input value="合计费用" type="text" readOnly="readOnly" class="inp2 color3" style="border: none;"/></td><td class="td-r" name = "flexible" style="width:20%;"><img name="editTeam" count="1" value="' + m + '" src="../img/ygzz_grxx_sub.png" class="editTeam-r team-r' + m + '"></td></tr>';
        ...
        for (var i = 0; i < array2.length; i++) {
            if (arrayN.indexOf(array2[i].name) != -1) {
                if (arrayN.indexOf(array2[i].name) == 2) {
                    ...
                    html += '<tr class="color3" style="width:100%;"><td style="width:40%;"><input value="' + m + '" type="text" readOnly="readOnly" class="inp2 color3" style="border: none;"/></td><td class="td-r"  name = "flexible" style="width:20%;"><img name="editTeam" count="1" value="' + m + '" src="../img/ygzz_grxx_sub.png" class="editTeam-r team-r' + m + '"></td></tr>';
    ...
    //行政车辆维修申请表(产业板块适用)
        ...
        html += '<table class="tab' + m + '" border="0" cellspacing="0" cellpadding="0" style="width:100%;border-collapse:separate; border-spacing:0px 0px;">';
        html += '<tr class="color3" style="width:100%;"><td style="width:40%;"><input value="详情" type="text" readOnly="readOnly" class="inp2 color3" style="border: none;"/></td><td class="td-r" name = "flexible" style="width:20%;"><img name="editTeam" count="1" value="' + m + '" src="../img/ygzz_grxx_sub.png" class="editTeam-r team-r' + m + '"></td></tr>';
        ...
        for (var k = 0; k < array2.length / arrayN.length; k++) {
            ...
            for (var j = 0; j < arrNum2.length; j++) {
                ...
                if (j == 0) {
                    ...
                    html += '<tr class="color3" style="width:100%;"><td style="width:40%;"><input type="text" readOnly="readOnly" class="inp2 color3" style="border: none;"/></td><td class="td-r" name = "flexible" style="width:20%;"><img name="editTeam" count="1" value="' + m + '" src="../img/ygzz_grxx_sub.png" class="editTeam-r team-r' + m + '"></td></tr>';
        ...
        for (var i = 0; i < array2.length; i++) {
            if (arrayN.indexOf(array2[i].name) != -1) {
                if (arrayN.indexOf(array2[i].name) == 0) {
                    html += '<div class="border1" name="editTeam" count="1" value="' + m + '"><span class="munTeam">第' + m + '组</span><img src="../img/ygzz_grxx_sub.png" class="editTeam-r team-r' + m + '"></div>';
...
function title_paixu(paixu_arr , packet_size,titlt_name){
    ...
    for (var j = 0; j < len; j++) {
        ...
        for (var i=0; i < paixu_arr.length; i++) {
            ...
            if(i == 0){
                html += '<table class="tab' + m + '" border="0" cellspacing="0" cellpadding="0" style="width:100%;border-collapse:separate; border-spacing:0px 0px;">';
                html += '<tr class="color3" style="width:100%;"><td style="width:40%;"><input value="' + titlt_name + m + '" type="text" readOnly="readOnly" class="inp2 color3" style="border: none;"/></td><td class="td-r"  name = "flexible" style="width:20%;"><img name="editTeam" count="1" value="' + m + '" src="../img/ygzz_grxx_sub.png" class="editTeam-r team-r' + m + '"></td></tr>';
                html += '<tr class="team' + m + ' color4" style="width:100%;"><td style="width:40%;"><input type="text" readOnly="readOnly" class="inp2 inpborder left color4" value="' + child_nodes[paixu_i].name + '"/></td><td style="width:65%;"><input readOnly="readOnly" class="inp2 inpborder right color4" value="' + child_nodes[paixu_i].value + '&nbsp&nbsp"/></td></tr>';
            }
            else if(i == paixu_arr.length-1){
                html += '<tr class="team' + m + ' color4" style="width:100%;"><td style="width:40%;"><input type="text" readOnly="readOnly" class="inp2 inpborder left color4" value="' + child_nodes[paixu_i].name + '"/></td><td style="width:65%;"><input readOnly="readOnly" class="inp2 inpborder right color4" value="' + child_nodes[paixu_i].value + '&nbsp&nbsp"/></td></tr>';
...
function caseDetail(titleName,titleArr){
    for (var j = 0; j < titleArr.length; j++) {
        ...
        if (j == 0) {
            html += '<table class="tab' + m + '" border="0" cellspacing="0" cellpadding="0" style="width:100%;border-collapse:separate; border-spacing:0px 0px;">';
            html += '<tr class="color3" style="width:100%;"><td style="width:60%;"><input value="'+ titleName +'" type="text" readOnly="readOnly" class="inp2 color3" style="border: none;"/></td><td class="td-r" name = "flexible" style="width:20%;"><img name="editTeam" count="1" value="' + m + '" src="../img/ygzz_grxx_sub.png" class="editTeam-r team-r' + m + '"></td></tr>';
...
function GrantApplicationForm(titleName,titleArr){
    for (var j = 0; j < titleArr.length; j++) {
        ...
        if (j == 0) {
            html += '<table class="tab' + m + '" border="0" cellspacing="0" cellpadding="0" style="width:100%;border-collapse:separate; border-spacing:0px 0px;">';
            html += '<tr class="color3" style="width:100%;"><td style="width:40%;"><input value=" '+titleName+' " type="text" readOnly="readOnly" class="inp2 color3" style="border: none;"/></td><td class="td-r" name = "flexible" style="width:20%;"><img name="editTeam" count="1" value="' + m + '" src="../img/ygzz_grxx_sub.png" class="editTeam-r team-r' + m + '"></td></tr>';
            html += '<tr class="team' + m + ' color4" style="width:100%;"><td style="width:40%;"><input type="text" readOnly="readOnly" class="inp2 inpborder left color4" value="' + parent_node[i].name + '"/></td><td style="width:65%;"><input readOnly="readOnly" class="inp2 inpborder right color4" value="' + parent_node[i].value + '&nbsp&nbsp"/></td></tr>';
        } else if (j == titleArr.length - 1) {
            html += '<tr class="team' + m + ' color4" style="width:100%;"><td style="width:40%;"><input type="text" readOnly="readOnly" class="inp2 inpborder left color4" value="' + parent_node[i].name + '"/></td><td style="width:60%;"><input readOnly="readOnly" class="inp2 inpborder right color4" value="' + parent_node[i].value + '&nbsp&nbsp"/></td></tr>';
...
$("#new_content").on("click", "input", function() {
    if ($(this).attr('name') == "editTeam") {
        ...
        if ($(this).attr('count') == 1) {
            ...
            $(this).attr('count', '0');
            $('.team-r' + num).attr('src', '../img/ygzz_grxx_add.png');
        } else {
            $('.team' + num).css('display', '');
            $(this).attr('count', '1');
            $('.team-r' + num).attr('src', '../img/ygzz_grxx_sub.png');
        }
    }
})
...
function getReplaceHTMLinfo(data) {
    ...
    var initZoom = 0.4
    if($("table.xdLayout").width()<((window.screen.width)*2)){
        initZoom=0.7
    }
    cmp.zoom("#container",{
        zoomMin:0.2,
            ...
            if ($(element1).attr("access") == "edit") {
                ...
                $(contentHTML).find("span[xd\\:binding='" + id + "']").each(function(index2, element2) {
                    if (('text' == type || 'relation' == type) && ('VARCHAR' == fieldtype || 'LONGTEXT' == fieldtype || 'DECIMAL' == fieldtype)) {
                        ...
                        newHTML += ' onblur=input_changeElement(this);fillText0(this)';
                        ...
                        newHTML +=' onblur=fillText(this) style=""'
                        //方法：给页面添加样式和事件
                        newHTML += HTML_addStyleEvent(element1, templeteId, currentNodeName);
                        newHTML += ' >';
                        if (undefined != value && value.length > 0) {
                        ...
                        //方法：给页面添加样式和事件
                        newHTML += HTML_addStyleEvent(element1, templeteId, currentNodeName);
                        newHTML += ' onchange=\"opt_changeSelecte(this);fillSelect(this);\"';
                        newHTML += ' >';
                        newHTML += sel_HTML;
                        newHTML += '</select></br>';
                        $(element2).prop('outerHTML', newHTML);
                        ...
                        if ('日期时间选取器' == extendNameType) {
                            newHTML += ' ontouchstart=\"jedateShowDatetime01(this);\"';
                        } else {
                            newHTML += ' ontouchstart=\"jedateShowDate(this);\"';
                        }
                        newHTML += ' >';
                        newHTML += '</input>';
                        newHTML += '<img src="../img/date.gif"/> ';
                        $(element2).prop('outerHTML', newHTML);
                        ...
                        newHTML += ' >';
                        newHTML += '</input>';
                        newHTML += '<img src="../img/selecetUser.gif"/> ';
                        $(element2).prop('outerHTML', newHTML);
...
//修改text的val值
function fillText0(obj){
    $(obj).attr("value",$(obj).val())

}

//修改textarea设置html为val值
function fillText(obj){
    $(obj).html($(obj).val())

}
//修改select选中的option的selected属性值
