  ...
  var sourceChunks = [
    {
      ...
      resources: [
        ...
        capUrlPrefix + '/htmls/origin/form/static/js/out-config.js' + version,
        capUrlPrefix + '/htmls/origin/form/static/js/vendor.cap4Form.js' + version,
        capUrlPrefix + '/htmls/origin/form/static/js/widget.cap4Form.js' + version,
        v5CommonUrlPrefix + '/widget/sui-iscroll.min.js' + version
      ]
    },
    {
      name: 'cordova',
    ...
    },
    {
      ...
      resources: [
        ...
        capUrlPrefix + '/htmls/origin/form/static/css/app.cap4Form.css' + version,
        capUrlPrefix + '/htmls/origin/form/static/js/app.cap4Form.js' + version
      ]
    },
    {
      name: 'interact',
