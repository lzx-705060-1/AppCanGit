...
var projectMembers = {};
(function() {
    var m3Error,m3i18n,m3Ajax,imgCanLoaded = true,imgIdArr = [];//NameArr=[];
    ...
    function initEvent() {
        ...
        $(".search-depart").on("tap", "li", function() {
            if(clickMark){
                ...
                m3.state.go(getGoPersonUrl(id) + "&page=project-team-project&id=" + id + "&from=m3&enableChat=true","",{"useNativebanner":false},1);
    ...
    function initData() {
        ...
        projectMembers.getData = function(param, options) {
            ...
            var url = m3.curServerInfo.url + "/mobile_portal/api/contacts2/projectTeam/members/" + projectMembers.parentData.id + "/" + projectMembers.num + "/20";
            m3Ajax({
                url: url,
                type: "GET",
